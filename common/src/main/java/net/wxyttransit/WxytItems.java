...
public class WxytItems {
    ...
    public static RegistryObject<Item>  WXYT_PSD_TOP_ITEM = new RegistryObject<>(()->new WxytItemPSDTopBase("sz_now"));
    public static RegistryObject<Item>  WXYT_BRUSH=new RegistryObject<>(()->new Item(new Item.Properties().arch$tab(WxytTransit.WXYT_MTR)));
}
