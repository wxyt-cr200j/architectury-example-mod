...
public class WxytBlockEntityTypes {
    ...
    public static RegistryObject<BlockEntityType<WxytPSDDoorOnly.TileEntityPSDDoor>> PSD_ONLY_DOOR_0_TILE_ENTITY=new RegistryObject<>(()->RegistryUtilities.getBlockEntityType(WxytPSDDoorOnly.TileEntityPSDDoor::new,WxytBlocks.WXYT_PSD_ONLY_DOOR_0.get()));
}